...
export const metadata: Metadata = {
  title: "Plumber Services Kemmerer, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Kemmerer, WY. Crystal Drain & Plumbing serves Kemmerer with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://images.pexels.com/photos/2279830/pexels-photo-2279830.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Kemmerer homeowners trust Crystal Drain & Plumbing for expert plumbing services in Lincoln County. From drain cleaning to water heater replacement, we have you covered."
