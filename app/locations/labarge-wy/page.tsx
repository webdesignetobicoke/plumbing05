...
export const metadata: Metadata = {
  title: "Plumber Services LaBarge, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in LaBarge, WY. Crystal Drain & Plumbing serves LaBarge with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09cf0c8a0d06ae6d54de_7Zl6TtnKCOEi4DxYr-8-kRYVjMb04oBGLZj5mFDsyGA.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing serves LaBarge and Lincoln County with reliable residential plumbing services. Our technicians understand the unique plumbing challenges of Wyoming's high desert climate."
