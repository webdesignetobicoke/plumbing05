...
export const metadata: Metadata = {
  title: "Plumber Services Marbleton, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Marbleton, WY. Crystal Drain & Plumbing serves Marbleton with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09d8cbdfabda680d7c7a_WJpJ8LiDBIm3ppSn15p64mkLk4JWnIAvF2kW1X_NLRQ.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Marbleton homeowners in Sublette County trust Crystal Drain & Plumbing for reliable residential plumbing services. We serve the communities of Southwest Wyoming with pride."
