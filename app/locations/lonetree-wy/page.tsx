...
export const metadata: Metadata = {
  title: "Plumber Services Lonetree, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Lonetree, WY. Crystal Drain & Plumbing serves Lonetree with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09d6a3ae0e01b74b2b0c_HuDpJmWJl8ND6K1YGrr5kC9OsI_Tux2CeEq2oT-DPPM.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing serves the Lonetree community and surrounding Uinta County with prompt, professional residential plumbing services."
