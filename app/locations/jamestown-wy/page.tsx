...
export const metadata: Metadata = {
  title: "Plumber Services Jamestown, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Jamestown, WY. Crystal Drain & Plumbing serves Jamestown with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09c58cb81c23472218db_9gjcgLXK3_xuD2AePlcR866AHYZKMFMW7wBvZ1TqUiE.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing proudly serves the Jamestown community in Sweetwater County. Our technicians are familiar with the plumbing demands of Wyoming's rural communities."
