...
export const metadata: Metadata = {
  title: "Plumber Services Eden, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Eden, WY. Crystal Drain & Plumbing serves Eden with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09aacbdfabda680d4894_WFnkT8CBK59IJTUaMeyEZve4vCXNxD-Lu8kxFoh6_ZQ.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Eden and the surrounding Sweetwater County communities rely on Crystal Drain & Plumbing for expert residential plumbing services. We're proud to serve Wyoming's communities large and small."
