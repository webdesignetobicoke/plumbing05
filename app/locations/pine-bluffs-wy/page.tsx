...
export const metadata: Metadata = {
  title: "Plumber Services Pine Bluffs, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Pine Bluffs, WY. Crystal Drain & Plumbing serves Pine Bluffs with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09e5be0b68b15db1fe3c_FWh_1SQYjyU5ckCQv9cWRGJ9bV2TpkQFn8iMIbVBR9A.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Pine Bluffs homeowners on Wyoming's eastern border choose Crystal Drain & Plumbing for reliable plumbing services. We serve Laramie County with the same expertise as our Rock Springs headquarters."
