...
export const metadata: Metadata = {
  title: "Plumber Services Ft Bridger, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Ft Bridger, WY. Crystal Drain & Plumbing serves Ft Bridger with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://images.pexels.com/photos/2279828/pexels-photo-2279828.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="The historic town of Fort Bridger deserves modern plumbing service. Crystal Drain & Plumbing serves Ft Bridger and Uinta County with prompt, professional residential plumbing and HVAC services."
