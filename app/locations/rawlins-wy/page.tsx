...
export const metadata: Metadata = {
  title: "Plumber Services Rawlins, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Rawlins, WY. Crystal Drain & Plumbing serves Rawlins with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      countySlug="carbon-county"
      phone="(647) 686-4566"
      heroImg="https://images.pexels.com/photos/2398310/pexels-photo-2398310.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Rawlins residents in Carbon County trust Crystal Drain & Plumbing for expert plumbing services. From routine maintenance to emergency repairs, we're here for Rawlins homeowners."
