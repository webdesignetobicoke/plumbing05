...
export const metadata: Metadata = {
  title: "Plumber Services Reliance, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Reliance, WY. Crystal Drain & Plumbing serves Reliance with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09f0db3ef3d37ea5c4ff_H88c_oyYCKsS2MsTYGeh7-sNWWd0NVWaE7mwJSeO60o.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Reliance residents in Sweetwater County count on Crystal Drain & Plumbing for all their plumbing needs. We serve this close-knit community with the same Gold Leaf Standard as our larger markets."
