...
export const metadata: Metadata = {
  title: "Plumber Services Farson, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Farson, WY. Crystal Drain & Plumbing serves Farson with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09b117d6d35491c6b1b6_AnKzJfRRuh-g9ZAtF1Crbxn5JODd0qtZt65eXIBIQao.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Farson is at the heart of Wyoming's wide open spaces, and Crystal Drain & Plumbing is proud to serve this community. We provide all residential plumbing services to Farson and surrounding Sweetwater County."
