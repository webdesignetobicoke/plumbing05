...
export const metadata: Metadata = {
  title: "Plumber Services McKinnon, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in McKinnon, WY. Crystal Drain & Plumbing serves McKinnon with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09dba777d5ef4e7002ca_1Bet0xKHn-jFpczZJYxDXAWmiQ8b0CsgDBhrJUCs7P0.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing serves McKinnon and the surrounding area in Sweetwater County. Our licensed plumbers are experienced with all residential plumbing needs in Wyoming."
