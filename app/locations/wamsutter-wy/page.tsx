...
export const metadata: Metadata = {
  title: "Plumber Services Wamsutter, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Wamsutter, WY. Crystal Drain & Plumbing serves Wamsutter with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09fecbdfabda680d9ebe_lHmmyMuy7QXPn4uUQX_WUlJMSSb-buFuT1H7ox7BYuo.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Wamsutter homeowners in Sweetwater County choose Crystal Drain & Plumbing for reliable residential plumbing services. We understand the unique needs of Wyoming's oil and gas communities."
