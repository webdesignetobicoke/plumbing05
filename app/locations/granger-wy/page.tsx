...
export const metadata: Metadata = {
  title: "Plumber Services Granger, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Granger, WY. Crystal Drain & Plumbing serves Granger with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09c0cbdfabda680d5a10_Wme6j9kn88EuqeXhJUYjlLnblIrXGjzeOe7epadF9XI.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Granger residents in Sweetwater County rely on Crystal Drain & Plumbing for all their residential plumbing needs. We provide fast, reliable service to rural Wyoming communities."
