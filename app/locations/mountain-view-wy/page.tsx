...
export const metadata: Metadata = {
  title: "Plumber Services Mountain View, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Mountain View, WY. Crystal Drain & Plumbing serves Mountain View with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      city="Mountain View"
      state="WY"
      slug="mountain-view-wy"
      county="Uinta County"
      countySlug="unita-county"
      phone="(647) 686-4566"
      heroImg="https://images.pexels.com/photos/2398313/pexels-photo-2398313.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Mountain View residents in Uinta County rely on Crystal Drain & Plumbing for prompt, professional plumbing services. We're your local Wyoming plumbing experts."
