...
export const metadata: Metadata = {
  title: "Plumber Services Frontier, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Frontier, WY. Crystal Drain & Plumbing serves Frontier with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09b51e3462cbcdf6d27f_bkLF7PzlQ8YZQ8V5HrVJfMELnLqLEi_P9gYaGEtZo1A.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing serves the Frontier community in Lincoln County with reliable residential plumbing services. No community is too remote for the Gold Leaf Standard."
