...
export const metadata: Metadata = {
  title: "Plumber Services Point of Rocks, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Point of Rocks, WY. Crystal Drain & Plumbing serves Point of Rocks with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      city="Point of Rocks"
      state="WY"
      slug="point-of-rocks-wy"
      county="Sweetwater County"
      countySlug="sweetwater-county"
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09e8e171f51614868c59_OySMnT6j0Ua-BiLtHwUmBnlmatdSFYSpqMo2cTSBv-g.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing proudly serves Point of Rocks and the surrounding Sweetwater County area. Our technicians provide fast, professional residential plumbing services to this historic Wyoming community."
