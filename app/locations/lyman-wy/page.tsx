...
export const metadata: Metadata = {
  title: "Plumber Services Lyman, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Lyman, WY. Crystal Drain & Plumbing serves Lyman with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://images.pexels.com/photos/2398314/pexels-photo-2398314.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Lyman and the greater Uinta County area rely on Crystal Drain & Plumbing for expert plumbing solutions. Our experienced technicians provide fast service and honest pricing."
