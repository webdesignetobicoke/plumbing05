...
export const metadata: Metadata = {
  title: "Plumber Services Evanston, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Evanston, WY. Crystal Drain & Plumbing serves Evanston with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://images.pexels.com/photos/2398312/pexels-photo-2398312.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing serves Evanston and Uinta County with comprehensive plumbing and HVAC services. As Wyoming's western gateway city, Evanston homeowners deserve reliable plumbing service they can count on."
