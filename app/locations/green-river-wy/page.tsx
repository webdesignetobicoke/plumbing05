...
export const metadata: Metadata = {
  title: "Plumber Services Green River, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Green River, WY. Crystal Drain & Plumbing serves Green River with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(307) 201-2437"
      heroImg="https://images.pexels.com/photos/2398311/pexels-photo-2398311.jpeg?auto=compress&cs=tinysrgb&w=1600"
      diagnosticFee="$110"
      rating="4.8"
      reviewCount="102"
      tagline="Green River folks deserve the rugged reliability that is Wyoming's hallmark. At Crystal Drain & Plumbing, we're driven by local values, ensuring every Green River household has access to the best in plumbing solutions."
