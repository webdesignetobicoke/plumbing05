...
export const metadata: Metadata = {
  title: "Plumber Services Opal, WY | Crystal Drain & Plumbing",
  description: "Expert plumbing and HVAC services in Opal, WY. Crystal Drain & Plumbing serves Opal with residential plumbing, water heaters, drain cleaning, and more.",
};
...
export default function Page() {
  return (
    <LocationPage
      ...
      phone="(647) 686-4566"
      heroImg="https://cdn.prod.website-files.com/66fbfa10acc227665751a712/66fc09e39d7ab3cff8b0d11b_GKs_yxcOkbXDCFpuWVMqhzFRilAPbmVBjbMNFXRJe44.webp"
      diagnosticFee="$110"
      rating="4.7"
      reviewCount="372"
      tagline="Crystal Drain & Plumbing serves Opal and the surrounding Lincoln County area. Our technicians provide all residential plumbing services to Wyoming's smaller communities with the same Gold Leaf Standard."
