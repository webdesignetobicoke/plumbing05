...
export const metadata: Metadata = {
  title: "Plumbing & HVAC Franchise Opportunities | Crystal Drain & Plumbing Toronto",
  description: "Own a Crystal Drain & Plumbing franchise. Bring the Gold Leaf Standard to the Greater Toronto Area with a proven plumbing business model.",
};
    ...
    <>
      ...
      <section style={{ background: "var(--primary)", padding: "3rem 2rem", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.75)", marginBottom: "2rem" }}>Own a Crystal Drain & Plumbing franchise and bring the Gold Leaf Standard to your community.</p>
        </div>
      </section>

      <section className="section">
        <div className="container" style={{ maxWidth: 800 }}>
          <h2 style={{ color: "var(--primary)", marginBottom: "1rem" }}>Build Your Future with Crystal Drain & Plumbing</h2>
          <p style={{ color: "var(--text-mid)", lineHeight: 1.8, marginBottom: "1.5rem" }}>Crystal Drain & Plumbing is a fast-growing Toronto-based plumbing and HVAC company built on the Gold Leaf Standard of service. Our franchise model gives motivated entrepreneurs the opportunity to own and operate their own plumbing business with the support of an established brand, proven systems, and experienced leadership.</p>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(220px,1fr))", gap: "1.5rem", marginBottom: "2rem" }}>
            {[
              ["Proven Brand", "Leverage the Crystal Drain & Plumbing name, reputation, and marketing systems."],
          ...
          <div style={{ background: "var(--primary)", padding: "2rem", color: "#fff", textAlign: "center" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.8)", marginBottom: "1.5rem" }}>Contact us to learn more about franchise opportunities with Crystal Drain & Plumbing.</p>
