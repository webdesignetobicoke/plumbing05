...
export const metadata: Metadata = {
  title: "Bathroom Plumbing Remodeling | Crystal Drain & Plumbing Toronto",
  description: "Crystal Drain & Plumbing handles all plumbing aspects of bathroom remodels — from relocating drain lines to installing new fixtures and supply lines.",
};
...
export default function Page() {
  return (
    <ServicePage
      ...
      tagline="Crystal Drain & Plumbing handles all plumbing aspects of bathroom remodels — from relocating drain lines to installing new fixtures and supply lines."
      sections={[
        {
        ...
        },
        {
          ...
          paragraphs: ["Moving plumbing is one of the most significant costs in a bathroom remodel. Crystal Drain & Plumbing works closely with your contractor or directly with you to plan the plumbing layout before walls are opened, ensuring efficient routing and code-compliant installation."],
        },
        {
          heading: "Why Choose Crystal Drain & Plumbing for Your Remodel",
