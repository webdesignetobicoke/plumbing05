...
export const metadata: Metadata = {
  title: "Plumbing & HVAC Financing Options Wyoming | Crystal Drain & Plumbing",
  description: "Crystal Drain & Plumbing offers financing through FTL Finance for convenient low-interest monthly payments on plumbing and HVAC services in Wyoming.",
};
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div style={{ background: "var(--primary)", padding: "2rem", color: "#fff", textAlign: "center" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.8)", marginBottom: "1.5rem" }}>Contact Crystal Drain & Plumbing today to discuss financing options for your plumbing or HVAC project.</p>
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
              <a href="tel:+18332697794" className="btn btn-primary">(647) 686-4566</a>
              <a href="/contact-us" className="btn btn-outline-white">Schedule Service</a>
            </div>
